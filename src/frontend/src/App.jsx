...
const PatientDocumentsPage = lazy(
  () =>
    import(
      './pages/Patients/PatientDocumentsPage'
    )
)
...
function ProtectedLayout({
  ...
  /*
   * Si el usuario recarga estando en una ruta protegida,
   * esperamos a que AuthContext intente restaurar la sesión.
   *
   * No lo enviamos al login mientras esa comprobación
  ...
  /*
   * Solo si ya terminó la restauración y no existe
   * una sesión válida se redirige al login.
   */
  if (!user) {
    return (
      <Navigate
    ...
    <Routes>
      ...
      <Route
        ...
        element={
          ...
          >
            <Navigate
              to="/configuracion?seccion=staff"
              replace
            />
          </ProtectedLayout>
        }
      ...
      <Route
        path="/pacientes/:patientId/consultas/nueva"
        element={
          <ProtectedLayout
            requiredPermission="consultations.create"
          >
      ...
      <Route
        path="/pacientes/:patientId/consultas/:consultationId/odontograma"
        element={
          <ProtectedLayout
            requiredPermission="consultations.view"
          >
            <ConsultationOdontogramPage />
          </ProtectedLayout>
        }
      />
      ...
      <Route
        path="/pacientes/:patientId/odontogramas"
        element={
          <ProtectedLayout
            requiredPermission="consultations.view"
          >
            <PatientOdontogramHistoryPage />
          </ProtectedLayout>
        }
      />
      ...
      <Route
        path="/pacientes/:patientId/documentos"
        element={
          <ProtectedLayout
      ...
      <Route
        ...
        element={
          <ProtectedLayout
            requiredPermission="clinic.manage"
          >
            <Navigate
              to="/configuracion?seccion=perfil"
              replace
            />
          </ProtectedLayout>
        }
